...
class StartUpsForm(models.Model):
  ...
  pitchDeckFile=models.FileField(upload_to='media/pitchdeckfile',null=True,blank=True,editable=True)      
  businessPlanFile=models.FileField(upload_to='media/businessPlan',null=True,blank=True,editable=True)
  ...
  financialModelFile= models.FileField(upload_to='media/financialModelFile',null=True,blank=True,editable=True)
  cooperatedWithInvestors= models.TextField(blank=True)
  financialFile = models.FileField(upload_to='media/financialFile',null=True,blank=True,editable=True)
