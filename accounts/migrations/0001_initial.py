    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=300, verbose_name='Phone Number')),
                ('id_number', models.CharField(max_length=300, verbose_name='ID Number')),
                ('code', models.CharField(max_length=300, verbose_name='Employe Code')),
